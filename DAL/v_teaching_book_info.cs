...
{
	/// <summary>
	/// 数据访问类:v_teaching_book_info
	/// </summary>
	public partial class v_teaching_book_info
	{
		public v_teaching_book_info()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(TSIMSServer.Model.v_teaching_book_info model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into v_teaching_book_info(");
			strSql.Append("college_num,college_name,department_num,department_name,major_num,major_name,class_num,class_name,semester,course_num,course_name,course_type,need_book,teacher_num,teacher_name,isbn,book_name,author,price,publisher,edition,remark,book_status,dept_check,college_check)");
			...
			parameters[22].Value = model.book_status;
			parameters[23].Value = model.dept_check;
			parameters[24].Value = model.college_check;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(TSIMSServer.Model.v_teaching_book_info model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update v_teaching_book_info set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from v_teaching_book_info ");
			strSql.Append(" where ");
			MySqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public TSIMSServer.Model.v_teaching_book_info DataRowToModel(DataRow row)
		{
			TSIMSServer.Model.v_teaching_book_info model=new TSIMSServer.Model.v_teaching_book_info();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select college_num,college_name,department_num,department_name,major_num,major_name,class_num,class_name,semester,course_num,course_name,course_type,need_book,teacher_num,teacher_name,isbn,book_name,author,price,publisher,edition,remark,book_status,dept_check,college_check ");
			strSql.Append(" FROM v_teaching_book_info ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM v_teaching_book_info ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from v_teaching_book_info T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "v_teaching_book_info";
